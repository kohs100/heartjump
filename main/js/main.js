...
const scripts = {
    bridge: {
        ...
        4: '긴장을 했나... 오후 일과 시작 전에<br>화장실 좀 다녀와야겠어.',
    ...
    select: {
        ...
        1: {
            header: '청년간담회가 첫 업무구나.<br>흠... 이중에서 가장 중요한 건?',
            sels: {
        ...
        3: {
            header: '배부르니까 졸리네... SNS 좋아요 누르러 가야겠어!<br>가장 마음에 드는 피드는?',
            sels: {
                0: '#퇴근#칼퇴#워라벨#욜로',
                1: '#내집마련#내돈내산#우리집#2PM',
                2: '#대졸#고졸#취업#자기개발',
                3: '#건강검진#건강#운동#다이어트',
                4: '#살기좋은도시#위촉장#위원회#월급루팡',
            }
        },
        4: {
